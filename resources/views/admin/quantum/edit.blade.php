<x-admin-form-layout 
    title="Edit Quantum"
    method="PUT"
    :action="route('admin.quantum.update', $quantum)"
    enctype="true"
    submitLabel="Update Quantum"
    submitLoadingLabel="Updating..."
    :cancelRoute="route('admin.quantum.index')">
    
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <x-admin-form-field 
            name="title" 
            label="Title" 
            placeholder="Enter quantum title"
            :value="$quantum->title"
            required="true" />
    ...
    <div>
        <x-admin-form-field 
            ...
            label="Description" 
            type="textarea"
            placeholder="Enter quantum description..."
            :value="$quantum->description" />
    </div>
