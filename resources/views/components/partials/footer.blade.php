<div class="relative flex items-center justify-center w-full h-auto pt-12 xs:pt-16 sm:pt-18 md:pt-20 overflow-hidden bg-gray-50">
    <!-- Background dots -->
    ...
    <div class="w-full relative z-10">
        <div class="max-w-xs xs:max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto px-3 xs:px-4 sm:px-6">
            <!-- Main Content Grid -->
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 xs:gap-10 sm:gap-12 md:gap-16 lg:gap-20">
                
                <!-- Left Content -->
                <div class="space-y-6 xs:space-y-8 sm:space-y-10">
                    <!-- Contact Section -->
                    <div class="text-xs xs:text-sm text-gray-600 space-y-3 xs:space-y-4">
                        <h3 class="font-roboto-slab text-lg xs:text-xl sm:text-2xl md:text-3xl font-semibold text-black">Contact</h3>
                        <div class="space-y-2 xs:space-y-3">
                            <a href="mailto:info@destrosolutions.com" class="block hover:text-blue-600 transition-colors duration-300">info@destrosolutions.com</a>
                            <a href="tel:+919398793452" class="block hover:text-blue-600 transition-colors duration-300">+91-93987 93452</a>
                            <a href="tel:+4915510142201" class="block hover:text-blue-600 transition-colors duration-300">+49-15510142201</a>
                        </div>
                    </div>

                    <!-- Quick Links Section -->
                    <div class="text-xs xs:text-sm text-gray-600 space-y-3 xs:space-y-4">
                        <h3 class="font-roboto-slab text-lg xs:text-xl sm:text-2xl md:text-3xl font-semibold text-black">Quick Links</h3>
                        <div class="grid grid-cols-2 gap-4 xs:gap-6 sm:gap-8">
                            <div class="space-y-2 xs:space-y-3">
                                <a href="/" class="block hover:text-blue-600 transition-colors duration-300">Home</a>
                                <a href="/products" class="block hover:text-blue-600 transition-colors duration-300">Products</a>
                                <a href="/services" class="block hover:text-blue-600 transition-colors duration-300">Services</a>
                                <a href="/trainings" class="block hover:text-blue-600 transition-colors duration-300">Trainings</a>
                            </div>
                            <div class="space-y-2 xs:space-y-3">
                                <a href="/sdv" class="block hover:text-blue-600 transition-colors duration-300">SDV</a>
                                <a href="/blog" class="block hover:text-blue-600 transition-colors duration-300">Blog</a>
                                <a href="/contact" class="block hover:text-blue-600 transition-colors duration-300">Contact US</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Locations Section -->
                    <div class="text-xs xs:text-sm text-gray-600 space-y-3 xs:space-y-4">
                        <h3 class="font-roboto-slab text-lg xs:text-xl sm:text-2xl md:text-3xl font-semibold text-black">Our Locations</h3>
                        <div class="space-y-3 xs:space-y-4">
                            <div class="flex items-start space-x-2 xs:space-x-3">
                                <!-- India Flag -->
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480" class="w-4 xs:w-5 h-4 xs:h-5 rounded-sm flex-shrink-0 mt-0.5">
                            ...
                            <div class="flex items-start space-x-2 xs:space-x-3">
                                <!-- Germany Flag -->
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 5 3" class="w-4 xs:w-5 h-4 xs:h-5 rounded-sm flex-shrink-0 mt-0.5">
            ...
            <div class="border-t border-gray-200 mt-8 xs:mt-10 sm:mt-12 md:mt-16">
                <div class="flex flex-col sm:flex-row justify-between items-center py-6 xs:py-8 sm:py-10 gap-4 xs:gap-6">
                    <!-- Copyright -->
                    ...
                    <div class="flex items-center gap-x-2 xs:gap-x-3 order-1 sm:order-2">
                        ...
                        <a href="https://facebook.com/destrosolutions" target="_blank" rel="noopener noreferrer" 
                           class="p-2 xs:p-2.5 bg-gray-600 rounded-full transition-all duration-300 hover:bg-[#1877F2] hover:scale-110 group">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" class="w-3 xs:w-4 h-3 xs:h-4 group-hover:scale-110 transition-transform duration-300">
                                <path d="M22.675 0h-21.35C.6 0 0 .6 0 1.342v21.316C0 23.4.6 24 1.325 24H12.82v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.894-4.788 4.66-4.788 1.325 0 2.463.1 2.795.144v3.24l-1.919.001c-1.504 0-1.796.715-1.796 1.763v2.314h3.587l-.467 3.622h-3.12V24h6.116C23.4 24 24 23.4 24 22.658V1.342C24 .6 23.4 0 22.675 0z"/>
                            </svg>
                        </a>
                        ...
                        <a href="https://linkedin.com/company/destrosolutions" target="_blank" rel="noopener noreferrer" 
                           class="p-2 xs:p-2.5 bg-gray-600 rounded-full transition-all duration-300 hover:bg-[#0A66C2] hover:scale-110 group">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" class="w-3 xs:w-4 h-3 xs:h-4 group-hover:scale-110 transition-transform duration-300">
                                <path d="M4.98 3.5C3.34 3.5 2 4.86 2 6.5s1.34 3 2.98 3 2.98-1.36 2.98-3S6.62 3.5 4.98 3.5zM2.4 8.99h5.16V21H2.4zM9.34 8.99h4.94v1.64h.07c.69-1.31 2.37-2.69 4.88-2.69 5.22 0 6.18 3.43 6.18 7.89V21h-5.15v-5.67c0-1.35-.02-3.09-1.89-3.09-1.89 0-2.18 1.48-2.18 3v5.76H9.34V8.99z"/>
                            </svg>
                        </a>
