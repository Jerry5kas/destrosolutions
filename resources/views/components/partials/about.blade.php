        ...
        <div class="flex flex-row justify-center items-center space-x-2 xs:space-x-3 sm:space-x-4 md:space-x-6 lg:space-x-8 xl:space-x-12 py-4 xs:py-5 sm:py-6 overflow-x-auto scrollbar-hide">
            ...
            >
                ...
                <svg
                    ...
                    fill="currentColor"
                    :class="activeTab === 'automotive' ? 'text-slate-600' : 'text-gray-300 group-hover:text-slate-500'"
                >
                ...
                >
                    ...
                    <!-- Animated underline -->
                    <span
                        class="absolute left-0 -bottom-1 h-0.5 bg-slate-600 transition-all duration-300 ease-out origin-left"
            ...
            >
                ...
                <svg viewBox="0 0 24 24"
                     ...
                     class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 transition-all duration-300"
                     fill="currentColor"
                     :class="activeTab === 'sdv' ? 'text-slate-600' : 'text-gray-300 group-hover:text-slate-500'">
            ...
            <div
                ...
                <svg viewBox="0 0 24 24"
                     ...
                     class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 transition-all duration-300"
                     fill="currentColor"
                     :class="activeTab === 'avionics' ? 'text-slate-600' : 'text-gray-300 group-hover:text-slate-500'">
            ...
            <div
                ...
                <svg fill="" version="1.1" id="Capa_1"
                     ...
                     xml:space="preserve"
                     class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 transition-all duration-300"
                     :class="activeTab === 'railways' ? 'fill-slate-600' : 'fill-gray-300 group-hover:fill-slate-500'">
                ...
                <div
                    class="relative text-xs sm:text-sm font-medium whitespace-nowrap"
                    :class="activeTab === 'railways' ? 'text-slate-600' : 'text-gray-300 group-hover:text-slate-500'">
                    Railways
                    <span
                        class="absolute left-0 -bottom-1 h-0.5 bg-slate-600 transition-all duration-300 ease-out origin-left"
            ...
            <div
                ...
                class="flex flex-col items-center space-y-1 sm:space-y-2 cursor-pointer transition group flex-shrink-0">
                <!-- Medical Icon -->
                <svg class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 transition-all duration-300" fill="currentColor" version="1.1" id="Layer_1"
                     xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                     viewBox="0 0 256 190"
                     enable-background="new 0 0 256 190" xml:space="preserve"
                     :class="activeTab === 'healthcare' ? 'text-slate-600' : 'text-gray-300 group-hover:text-slate-500'">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <path
