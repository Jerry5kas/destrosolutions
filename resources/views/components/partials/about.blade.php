        ...
        <div
            ...
            >
                ...
                <svg
                    ...
                    fill="currentColor"
                    :class="activeTab === 'automotive' ? 'text-blue-700' : 'text-gray-300 group-hover:text-blue-700'"
                >
            ...
            >
                ...
                <svg viewBox="0 0 24 24"
                     ...
                     class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 transition-all duration-300"
                     fill="currentColor"
                     :class="activeTab === 'sdv' ? 'text-blue-700' : 'text-gray-300 group-hover:text-blue-700'">
            ...
            <div
                ...
                <svg viewBox="0 0 24 24"
                     ...
                     class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 transition-all duration-300"
                     fill="currentColor"
                     :class="activeTab === 'avionics' ? 'text-blue-700' : 'text-gray-300 group-hover:text-blue-700'">
            ...
            <div
                ...
                <svg fill="" version="1.1" id="Capa_1"
                     ...
                     xml:space="preserve"
                     class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 transition-all duration-300"
                     :class="activeTab === 'railways' ? 'fill-blue-700' : 'fill-gray-300 group-hover:fill-blue-700'">
                ...
                <div
                    class="relative text-xs sm:text-sm font-medium whitespace-nowrap"
                    :class="activeTab === 'railways' ? 'text-blue-700' : 'text-gray-300 group-hover:text-blue-700'">
                    Railways
                    <span
                        class="absolute left-0 -bottom-1 h-0.5 bg-blue-700 transition-all duration-300 ease-out origin-left"
            ...
            <div
                ...
                <svg class="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 transition-all duration-300" fill="currentColor"
                     ...
                     :class="activeTab === 'healthcare' ? 'text-blue-700' : 'text-gray-300 group-hover:text-blue-700'">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <path
