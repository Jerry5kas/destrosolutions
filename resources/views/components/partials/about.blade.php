<div data-reveal-scope>
    ...
    <div class="about-tabs-container text-xs xs:text-sm text-center max-w-xs xs:max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto px-3 xs:px-4 sm:px-6">
        ...
        <div
            ...
            <div
                data-tab="automotive"
                class="tab-button flex flex-col items-center space-y-1 sm:space-y-2 cursor-pointer transition group flex-shrink-0"
            >
                <!-- Icon -->
                <svg
                    viewBox="0 0 20 20"
                ...
                <!-- Label -->
                <div class="relative text-xs sm:text-sm font-medium whitespace-nowrap">
                    Automotive
                    <!-- Animated underline -->
                    <span class="tab-underline absolute left-0 -bottom-1 h-0.5 bg-blue-700 transition-all duration-300 ease-out origin-left"></span>
                </div>
            </div>
        ...
        <div class="mt-4 xs:mt-5 sm:mt-6">
            <div data-tab-content="automotive" class="tab-content max-w-xs xs:max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 xs:gap-4 sm:gap-5 md:gap-6 lg:gap-8 xl:gap-10 2xl:gap-16 px-2 xs:px-3 sm:px-4">
                <x-partials.card1/>
                <x-partials.card1/>
                <x-partials.card1/>
                <x-partials.card1/>
            ...
            <div data-tab-content="sdv" class="tab-content max-w-xs xs:max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 xs:gap-4 sm:gap-5 md:gap-6 lg:gap-8 xl:gap-10 2xl:gap-16 px-2 xs:px-3 sm:px-4" style="display: none;">
                <x-partials.card1/>
                <x-partials.card1/>
                <x-partials.card1/>
                <x-partials.card1/>
            ...
            <div data-tab-content="avionics" class="tab-content max-w-xs xs:max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 xs:gap-4 sm:gap-5 md:gap-6 lg:gap-8 xl:gap-10 2xl:gap-16 px-2 xs:px-3 sm:px-4" style="display: none;">
                <x-partials.card1/>
                <x-partials.card1/>
                <x-partials.card1/>
                <x-partials.card1/>
            ...
            <div data-tab-content="railways" class="tab-content max-w-xs xs:max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 xs:gap-4 sm:gap-5 md:gap-6 lg:gap-8 xl:gap-10 2xl:gap-16 px-2 xs:px-3 sm:px-4" style="display: none;">
                <x-partials.card1/>
                <x-partials.card1/>
                <x-partials.card1/>
                <x-partials.card1/>
            ...
            <div data-tab-content="healthcare" class="tab-content max-w-xs xs:max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 xs:gap-4 sm:gap-5 md:gap-6 lg:gap-8 xl:gap-10 2xl:gap-16 px-2 xs:px-3 sm:px-4" style="display: none;">
                <x-partials.card1/>
                <x-partials.card1/>
                <x-partials.card1/>
                <x-partials.card1/>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Initializing About Tabs System');
    
    const tabButtons = document.querySelectorAll('.tab-button');
    const tabContents = document.querySelectorAll('.tab-content');
    let activeTab = 'automotive';
    ...
    function updateTabDisplay() {
        ...
        tabButtons.forEach(button => {
            ...
            if (tabName === activeTab) {
                ...
                if (icon) icon.style.color = '#1d4ed8'; // blue-700
                if (text) text.style.color = '#1d4ed8'; // blue-700
                if (underline) {
                ...
                if (icon) icon.style.color = '#d1d5db'; // gray-300
                if (text) text.style.color = '#d1d5db'; // gray-300
                if (underline) {
    ...
    function animateTabTransition() {
        ...
        // Animate in
        activeContent.style.transition = 'opacity 0.5s ease-out, transform 0.5s ease-out';
        ...
        cards.forEach((card, index) => {
            ...
            }, index * 100 + 200); // Stagger animation
        });
    }
    ...
    console.log('About Tabs System initialized successfully');
});
</script>
