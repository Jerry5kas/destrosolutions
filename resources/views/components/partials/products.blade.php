            ...
            >
                <template x-for="(img, index) in doubledImages" :key="index">
                    ...
                    <div class="flex-shrink-0 relative group overflow-hidden" data-reveal :class="'reveal-delay-' + (index % 6)">
                        ...
                        <!-- Overlay fade -->
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-blue-700/70 via-blue-700/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 ease-out z-10">
                        </div>
