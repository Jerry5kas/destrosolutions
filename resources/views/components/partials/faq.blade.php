<div class="space-y-6 pb-16" x-data="faqSection">
    <h1 class="w-full text-center font-roboto-slab text-2xl font-semibold">
        Frequently Asked Questions.
    </h1>

    <div class="max-w-6xl mx-auto grid grid-cols-3 gap-12 text-sm text-gray-600 py-6">
        <!-- Left Column -->
            ...
            <div class="w-full max-w-sm divide-y divide-gray-200 bg-white rounded-xl">
                <template x-for="(item, index) in faqs.slice(0, 4)" :key="index">
                    <div class="py-4 w-full">
                        <button
                            @click="toggle(index)"
                            class="w-full flex items-center justify-between text-left gap-5 group"
                        >
                            <div class="flex items-center gap-x-2 text-gray-800 font-medium w-full">
                                <span x-text="item.q" class="block truncate"></span>
                            </div>

                            <!-- Arrow -->
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                 stroke-width="1.5" stroke="currentColor"
                                 class="w-4 h-4 text-gray-600 transform transition-transform duration-300 flex-shrink-0"
                        ...
                        <div
                            ...
                            class="mt-3 text-gray-600 text-sm leading-relaxed w-full"
                            x-text="item.a">
                        </div>
                    </div>
                </template>
        ...
        <div class="text-sm text-gray-600 leading-relaxed">
            ...
            <ul class="space-y-2">
                <li class="flex items-start gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mt-0.5 text-gray-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75" />
                    </svg>
                    <span>Cybersecurity Management Systems</span>
                </li>
                ...
                <li class="flex items-start gap-2">
                    ...
                    <span>Software Update Management Systems</span>
                </li>
                ...
                <li class="flex items-start gap-2">
                    ...
                    <span>ASPICE (Automotive SPICE)</span>
                </li>
    ...
    <div class="w-full text-center">
        <button class="max-w-max mx-auto bg-black text-white px-4 py-2">More Information</button>
    </div>
</div>
