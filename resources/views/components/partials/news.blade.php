<div class="w-full py-20 border-t border-b border-gray-300">
    <div class="max-w-6xl mx-auto flex flex-row justify-center items-center gap-x-5  ">
        <div class="w-1/5 flex flex-col gap-y-3">
            <div class="text-2xl font-semibold font-roboto-slab ">
                What's on and Latest News.
            </div>
            <div class="underline underline-offset-2 text-gray-400 text-sm">All events</div>
        </div>
        ...
        <div class="relative w-full sm:w-4/5 mx-auto group ">
            ...
            >
                ...
                <div class="overflow-hidden relative">
                    ...
                    >
                        <template x-for="(slide, index) in slides" :key="index">
                            <div class="flex-shrink-0 w-full px-6 sm:px-16">
                                <div class="flex flex-col items-start justify-start space-y-5 py-6 sm:py-10">
                                    <div class="text-lg sm:text-2xl font-roboto-slab font-semibold" x-text="slide.title"></div>
                                    <div class="text-sm text-gray-600 leading-relaxed" x-text="slide.text"></div>
                                    <div>
                                        <a :href="slide.link" class="text-sm underline underline-offset-4 text-gray-700 hover:text-gray-900 transition">Enter now</a>
                                    </div>
                                </div>
                            </div>
                        </template>
                ...
                <!-- Navigation Arrows -->
                <div class="absolute top-1/2 left-0 right-0 -translate-y-1/2 flex items-center justify-between px-2 sm:px-0">
                    <!-- Left -->
                    <button
                        @click="prev()"
                        @mouseenter="stopAutoSlide()"
                        @mouseleave="startAutoSlide()"
                        class="bg-white/80 hover:bg-white rounded-full p-2 shadow-md transition-all duration-500 hidden sm:flex items-center justify-center
                ...
                <div class="flex sm:hidden justify-center gap-4 mt-4">
                    <button @click="prev()" class="bg-gray-200 p-2 rounded-full hover:bg-gray-300 transition">
                    ...
                    <button @click="next()" class="bg-gray-200 p-2 rounded-full hover:bg-gray-300 transition">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 text-gray-700">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                        </svg>
                    </button>
