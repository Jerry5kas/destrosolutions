                    ...
                    <div class="max-w-7xl mx-auto flex flex-row justify-between items-center gap-8">
                        <div class="w-3/4 flex flex-row justify-evenly items-center">
                            ...
                            @foreach($teamMembers as $member)
                                <div class="inset-0 z-20 w-60 h-72 bg-white flex flex-row justify-start relative group overflow-hidden">
                                    <div class="flex flex-col gap-y-2 relative w-full h-full">
                                        <!-- Image -->
                                        <img
                                            src="{{ $member['image'] }}"
                                            alt="{{ $member['name'] }}"
                                            class="h-full w-full object-contain transition-transform duration-700 ease-out transform group-hover:scale-110 group-hover:translate-y-3">
                                        <!-- Bottom content -->
                                        <div class="bg-white w-full h-auto text-start space-y-2 absolute -bottom-0">
                                            <!-- Always visible -->
                                            ...
                                            <div class="bottom-0 w-9 border-b border-gray-200"></div>

                                            <!-- Description with staggered hover -->
                                            <div class="text-xs text-gray-600 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 delay-150">
                                                {{ $member['description'] }}
                                            </div>
                                        </div>
                                    ...
                                    <!-- Social Icons Panel -->
                                    <div class="absolute bg-white p-2 rounded-md top-1/2 -right-10 flex flex-col justify-center items-center gap-3 transform transition-all duration-500 ease-out group-hover:right-0">
                                        <!-- Facebook -->
                                        <a href="#" class="w-4 h-4 text-gray-600 hover:text-blue-600 transform translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 delay-75">
                                        ...
                                        <!-- Instagram -->
                                        <a href="#" class="w-4 h-4 text-gray-600 hover:text-pink-500 transform translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 delay-150">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <!-- Twitter -->
                                        <a href="#" class="w-4 h-4 text-gray-600 hover:text-sky-500 transform translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 delay-225">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="w-1/4 space-y-5">
                            <div class="font-roboto-slab font-semibold text-2xl">Our Amazing Team Members</div>
