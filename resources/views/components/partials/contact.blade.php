<div class="border-b border-b-gray-300 mb-12 xs:mb-16 sm:mb-18 md:mb-20 pb-12 xs:pb-16 sm:pb-18 md:pb-20">
    <div
        ...
        <div class="flex-1 py-4 xs:py-6 sm:py-8 flex flex-col justify-center items-center gap-y-3 xs:gap-y-4 sm:gap-y-5 md:gap-y-6 text-center md:text-left">
            ...
            <span
                class="max-w-xs xs:max-w-sm sm:max-w-lg md:max-w-xl lg:max-w-2xl xl:max-w-3xl text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl mx-auto md:mx-0 text-justify sm:text-center text-gray-400 leading-relaxed px-2">
        ...
        <div class="flex-1 flex flex-col gap-4 xs:gap-5 sm:gap-6 text-xs xs:text-sm">
            ...
            <div class="w-full flex flex-col md:flex-row items-center gap-4 xs:gap-5 sm:gap-6">
                ...
                <div class="relative w-full">
                    <input type="text" id="mobile" placeholder=" "
                           class="peer w-full bg-white text-gray-800 p-2 xs:p-3 border-b border-gray-300 focus:outline-none focus:border-gray-600 transition-colors duration-300 text-xs xs:text-sm"/>
                    <label for="mobile"
                           class="absolute left-2 xs:left-3 top-2 xs:top-3 text-gray-400 text-xs xs:text-sm transition-all duration-300 peer-placeholder-shown:top-2 xs:peer-placeholder-shown:top-3 peer-placeholder-shown:text-gray-400 peer-placeholder-shown:text-xs xs:peer-placeholder-shown:text-sm peer-focus:-top-2 xs:peer-focus:-top-3 peer-focus:text-gray-600 peer-focus:text-xs">Mobile</label>
                </div>
            ...
            <!-- Message -->
            <div class="relative w-full">
                <textarea id="message" placeholder=" " rows="2"
            ...
            <!-- Button -->
            <button
                class="bg-slate-600 py-2 xs:py-3 px-4 xs:px-5 sm:px-6 hover:bg-slate-500 text-white font-semibold rounded-md transition-colors duration-300 flex items-center justify-center gap-2 text-xs xs:text-sm">
                <!-- Paper Plane Icon -->
