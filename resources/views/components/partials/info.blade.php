    ...
    <div class="max-w-xs xs:max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4" data-reveal>
        ...
        <div
            ...
            <div class="inline-flex gap-x-1 xs:gap-x-2 sm:gap-x-3 text-xs xs:text-sm items-start"><span><svg
                        ...
                        class="icon icon-tabler icons-tabler-outline icon-tabler-cloud-cog w-3 xs:w-4 sm:w-5 h-3 xs:h-4 sm:h-5 flex-shrink-0"><path
            ...
            <div class="inline-flex gap-x-1 sm:gap-x-3 text-xs sm:text-sm items-start"><span><svg
                        ...
                        stroke-linejoin="round"
                        class="w-3 xs:w-4 sm:w-5 h-3 xs:h-4 sm:h-5 flex-shrink-0 icon icon-tabler icons-tabler-outline icon-tabler-lock"><path
                            stroke="none" d="M0 0h24v24H0z" fill="none"/><path
            ...
            <div class="inline-flex gap-x-1 sm:gap-x-3 text-xs sm:text-sm items-start"><span><svg
                        ...
                        stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round"
                        class="w-3 xs:w-4 sm:w-5 h-3 xs:h-4 sm:h-5 flex-shrink-0 icon icon-tabler icons-tabler-outline icon-tabler-device-desktop-cog"><path
                            stroke="none" d="M0 0h24v24H0z" fill="none"/><path
            ...
            <div class="inline-flex gap-x-1 sm:gap-x-3 text-xs sm:text-sm items-start"><span><svg
                        ...
                        stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round"
                        class="w-3 xs:w-4 sm:w-5 h-3 xs:h-4 sm:h-5 flex-shrink-0 icon icon-tabler icons-tabler-outline icon-tabler-car-4wd"><path
                            stroke="none" d="M0 0h24v24H0z" fill="none"/><path
